...
import { Menu, X, LogOut, LayoutDashboard, Car, Package, Settings, CreditCard, User as UserIcon, Users, Activity, ChevronLeft, ChevronRight, Headphones, Wallet, Zap, Bell, Wifi, WifiOff, Clock, FileBarChart, ShoppingBag, UserPlus, Gift } from 'lucide-react';
